...
def get_arrival_times(stop: str, direction: int, limit: int):
    ...
    for stop in data["data"]:
        ...
        if stop["attributes"]["status"] is not None:
            arrivalTimes.append(stop['attributes']['status'])
            continue
